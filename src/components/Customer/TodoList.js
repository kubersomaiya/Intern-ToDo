  ...
  return (
    <>
      <div className="mb-2 d-flex">
        <Button variant="outline-dark edit" onClick={getTodos} style={{ width: "40%", height: "50%" , margin : "2%" }}>
          Refresh List
        </Button>
        <Button variant="warning text-white" style={{ width: "40%", height: "50%" , margin : "2%"}} onClick={handleTodo}>
          Dashboard
        </Button>
      </div>
